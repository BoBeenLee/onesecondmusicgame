...
function GameRankCard(props: IProps) {
  ...
  const makeIconName = (iconNameRankDiff: number) => {
    if (iconNameRankDiff < 0) {
      return 'caret-down-min';
    } else if (iconNameRankDiff === 0) {
      return 'minus-min';
    } else {
      return 'caret-up-min';
    }
  ...
  const makeIconColor = (iconColorRankDiff: number) => {
    if (iconColorRankDiff < 0) {
      return colors.red400;
    } else if (iconColorRankDiff === 0) {
      return colors.white;
    } else {
