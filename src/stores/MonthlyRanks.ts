...
import {getRankingInfoOfMonthsUsingGET} from 'src/apis/rank';
...
const MonthlyRanks = types
  ...
  .actions(self => {
    ...
    const fetch = flow(function* () {
      const response: RetrieveAsyncFunc<typeof getRankingInfoOfMonthsUsingGET> =
        yield getRankingInfoOfMonthsUsingGET();
